India Post Tracking API - Java
================================
Use Java to track IndiaPost shipments with India Post Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.indiapost;
    ...
    public class CreateIndiaPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("ET794773059IN");
                createTrackingParams.setCourierCode("india-post");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateIndiaPostTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("RM771391365IN");
                createTrackingParams1.setCourierCode("india-post");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("RT568006977IN");
                createTrackingParams2.setCourierCode("india-post");
...
Get status of the shipment:
    ...
    public class GetIndiaPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("RM771391365IN,RT568006977IN");
                trackingParams.setCourierCode("india-post");
...
Update a tracking by ID:
    ...
    public class UpdateIndiaPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "98d159573d18239ea855c9a5a140674b";

India Post Tracking API - .Net
================================
Use .Net to track India Post shipments with India Post Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "RT568006977IN";
                  createTrackingParams.courierCode = "india-post";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "RT568006977IN,RM771391365IN";
                  getTrackingResultsParams.courierCode = "india-post";

# TrackingMore: India Post Tracking API & Webhook
[India Post Tracking API](https://www.trackingmore.com/india-post-tracking-api.html) enables you to connect tracking info of India Post shipments into your system, improving shipment visibility. 

Besides [India Post Tracking](https://www.trackingmore.com/india-post-tracking.html), TrackingMore supports shipment tracking across 1,200+ global carriers through a robust [multi-carrier shipment tracking API](https://www.trackingmore.com/tracking-api).
...
### Features
   *  Unified real-time tracking information for India Post shipments.
